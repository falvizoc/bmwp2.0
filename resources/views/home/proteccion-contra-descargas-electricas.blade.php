<x-app-layout>
    {{-- SECCIÓN HERO --}}
    <section class="relative h-full min-h-screen bg-no-repeat bg-center bg-cover bg-fixed" style="background-image: url('{{ asset('img/hero/proteccionDescargas.png') }}')">
    ...
    <section id="ventajas" class="relative py-10 md:py-16 bg-white overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 md:px-8">
            <div class="px-4 flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div class="relative max-w-md lg:max-w-3xl">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="">
                                <a class="group block h-auto xl:h-128 p-8 border border-green-500 border-opacity-30 hover:border-opacity-100 rounded-3xl transition duration-200" href="#">
                                    <div class="flex h-full flex-col items-start">
                                        <i class="fas fa-shield-alt text-green-500 text-3xl mb-6"></i> <!-- Icono de escudo -->
                                        <div class="mt-auto max-w-xs">
                                            <h4 class="text-xl sm:text-2xl mb-2 text-black">
                                                Protección Total
                                            </h4>
                                            <p class="text-gray-500 tracking-tight leading-5">
                                                Protección completa contra las amenazas eléctricas, asegurando un entorno seguro.
                                            </p>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="">
                                <a class="group block h-auto xl:h-128 p-8 border border-green-500 border-opacity-30 hover:border-opacity-100 rounded-3xl transition duration-200" href="#">
                                    <div class="flex h-full flex-col items-start">
                                        <i class="fas fa-lock text-green-500 text-3xl mb-6"></i> <!-- Icono de candado -->
                                        <div class="mt-auto max-w-xs">
                                            <h4 class="text-xl sm:text-2xl mb-2 text-black">
                                                Sistemas Seguros
                                            </h4>
                                            <p class="text-gray-500 tracking-tight leading-5">
                                                Implementación de tecnología avanzada para garantizar un entorno eléctrico seguro.
                                            </p>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a class="group block h-auto xl:h-128 p-8 border border-green-500 border-opacity-30 hover:border-opacity-100 rounded-3xl transition duration-200" href="#">
                                    <div class="flex h-full flex-col items-start">
                                        ...
                                        <div class="mt-auto max-w-xs">
                                            ...
                                            <p class="text-gray-500 tracking-tight leading-5">
                                                Servicios de mantenimiento preventivo para asegurar la fiabilidad del sistema.
                                            </p>
                                        </div>
                                    </div>
                                </a>
                ...
                <img class="h-80 md:h-96 object-cover object-center" src="{{ asset('img/beneficios/proteccionDescargas.jpg') }}" alt="Protección contra Descargas Eléctricas">
            </div>
        </div>
    </section>
    ...
    <section class="bg-gray-100">
        <div class="py-8 lg:py-16 mx-auto px-4">
            ...
            <h4 class="text-xl md:text-3xl font-light text-gray-800 text-center mb-10">
                En alianza con los principales fabricantes de sistemas de protección contra descargas eléctricas.
            </h4>
