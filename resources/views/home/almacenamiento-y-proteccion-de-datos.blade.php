    ...
    <section id="ventajas" class="relative py-10 md:py-16 bg-white overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 md:px-8">
            <div class="px-4 flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div class="relative max-w-md lg:max-w-3xl">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="">
                                <a class="group block h-auto xl:h-128 p-8 border border-green-500 border-opacity-30 hover:border-opacity-100 rounded-3xl transition duration-200" href="#">
                                    <div class="flex h-full flex-col items-start">
                                        <i class="fas fa-undo text-green-500 text-3xl mb-6"></i> <!-- Icono de recuperación -->
                                        <div class="mt-auto max-w-xs">
                                            <h4 class="text-xl sm:text-2xl mb-2 text-black">
                                                Recuperación de Desastres
                                            </h4>
                                            <p class="text-gray-500 tracking-tight leading-5">
                                                Soluciones para restaurar tus datos rápidamente ante cualquier eventualidad.
                                            </p>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="">
                                <a class="group block h-auto xl:h-128 p-8 border border-green-500 border-opacity-30 hover:border-opacity-100 rounded-3xl transition duration-200" href="#">
                                    <div class="flex h-full flex-col items-start">
                                        <i class="fas fa-tachometer-alt text-green-500 text-3xl mb-6"></i> <!-- Icono de rendimiento -->
                                        <div class="mt-auto max-w-xs">
                                            <h4 class="text-xl sm:text-2xl mb-2 text-black">
                                                Alto Rendimiento
                                            </h4>
                                            <p class="text-gray-500 tracking-tight leading-5">
                                                Almacenamiento de alto rendimiento para asegurar la eficiencia de tus operaciones.
                                            </p>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="">
                                <a class="group block h-auto xl:h-128 p-8 border border-green-500 border-opacity-30 hover:border-opacity-100 rounded-3xl transition duration-200" href="#">
                                    <div class="flex h-full flex-col items-start">
                                        <i class="fas fa-layer-group text-green-500 text-3xl mb-6"></i> <!-- Icono de escalabilidad -->
                                        <div class="mt-auto max-w-xs">
                                            <h4 class="text-xl sm:text-2xl mb-2 text-black">
                                                Escalabilidad
                                            </h4>
                                            <p class="text-gray-500 tracking-tight leading-5">
                                                Crece y adapta tus soluciones de almacenamiento a medida que lo necesites.
                                            </p>
                                        </div>
                                    </div>
                                </a>
                ...
                <img class="h-80 md:h-96 object-cover object-center" src="{{ asset('img/beneficios/almacenamiento.jpg') }}" alt="Sistemas de Almacenamiento y Protección de Datos">
            </div>
        </div>
    </section>
    ...
    <section class="bg-gray-100">
        <div class="py-8 lg:py-16 mx-auto px-4">
            ...
            <h4 class="text-xl md:text-3xl font-light text-gray-800 text-center mb-10">
                En alianza con los principales fabricantes de almacenamiento y protección de datos.
            </h4>
