    ...
    <section id="ventajas" class="relative py-10 md:py-16 bg-white overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 md:px-8">
            <div class="px-4 flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div class="relative max-w-md lg:max-w-3xl">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="">
                                <a class="group block h-auto xl:h-128 p-8 border border-green-500 border-opacity-30 hover:border-opacity-100 rounded-3xl transition duration-200" href="#">
                                    <div class="flex h-full flex-col items-start">
                                        <i class="fas fa-key text-green-500 text-3xl mb-6"></i> <!-- Icono de acceso -->
                                        <div class="mt-auto max-w-xs">
                                            <h4 class="text-xl sm:text-2xl mb-2 text-black">
                                                Acceso Completo
                                            </h4>
                                            <p class="text-gray-500 tracking-tight leading-5">
                                                Accede a todas las funcionalidades que tu empresa necesita con licencias completas.
                                            </p>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="">
                                <a class="group block h-auto xl:h-128 p-8 border border-green-500 border-opacity-30 hover:border-opacity-100 rounded-3xl transition duration-200" href="#">
                                    <div class="flex h-full flex-col items-start">
                                        <i class="fas fa-sync-alt text-green-500 text-3xl mb-6"></i> <!-- Icono de actualizaciones -->
                                        <div class="mt-auto max-w-xs">
                                            <h4 class="text-xl sm:text-2xl mb-2 text-black">
                                                Actualizaciones Seguras
                                            </h4>
                                            <p class="text-gray-500 tracking-tight leading-5">
                                                Mantén tu software actualizado con las últimas mejoras y parches de seguridad.
                                            </p>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a class="group block h-auto xl:h-128 p-8 border border-green-500 border-opacity-30 hover:border-opacity-100 rounded-3xl transition duration-200" href="#">
                                    <div class="flex h-full flex-col items-start">
                                        ...
                                        <div class="mt-auto max-w-xs">
                                            ...
                                            <p class="text-gray-500 tracking-tight leading-5">
                                                Asesoría y soporte técnico profesional para resolver cualquier problema.
                                            </p>
                                        </div>
                                    </div>
                                </a>
                ...
                <img class="h-80 md:h-96 object-cover object-center" src="{{ asset('img/beneficios/licenciamiento.jpg') }}" alt="Licenciamiento de Software">
            </div>
        </div>
    </section>
    ...
    <section class="bg-gray-100">
        <div class="py-8 lg:py-16 mx-auto px-4">
            ...
            <h4 class="text-xl md:text-3xl font-light text-gray-800 text-center mb-10">
                En alianza con los principales fabricantes de software para empresas.
            </h4>
