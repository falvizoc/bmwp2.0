<x-app-layout>
    {{-- SECCIÓN HERO --}}
    <section class="relative h-full min-h-screen bg-no-repeat bg-center bg-cover bg-fixed" style="background-image: url('{{ asset('img/hero/accesoriosRefacciones.png') }}')">
        <div class="absolute z-30 inset-0 max-w-7xl mx-auto px-4 md:px-12 py-20 2xl:py-28 mt-10">
            <h1 class="text-white text-4xl md:text-5xl 2xl:text-6xl mb-4">
                Todo en Accesorios y Refacciones
            </h1>
            <h2 class="tracking-wide text-2xl md:text-3xl 2xl:text-4xl text-white max-w-md md:max-w-3xl mb-8 font-light">
                Encuentra accesorios, refacciones y consumibles para mantener tus equipos funcionando a pleno rendimiento
            </h2>
    ...
    <section id="ventajas" class="relative py-10 md:py-16 bg-white overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 md:px-8">
            <div class="px-4 flex flex-col md:flex-row items-center justify-between">
                <div class="flex-1">
                    <div class="relative max-w-md lg:max-w-4xl mx-auto lg:mx-0 mb-8">
                        ...
                        <p class="max-w-2xl text-base md:text-2xl text-gray-700 font-light">
                            Durabilidad y Compatibilidad Garantizada
                        </p>
                    </div>
                    <div class="relative max-w-md lg:max-w-3xl">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="">
                                <a class="group block h-auto xl:h-128 p-8 border border-green-500 border-opacity-30 hover:border-opacity-100 rounded-3xl transition duration-200" href="#">
                                    <div class="flex h-full flex-col items-start">
                                        <i class="fas fa-th-large text-green-500 text-3xl mb-6"></i> <!-- Icono de variedad -->
                                        <div class="mt-auto max-w-xs">
                                            <h4 class="text-xl sm:text-2xl mb-2 text-black">
                                                Variedad Amplia
                                            </h4>
                                            <p class="text-gray-500 tracking-tight leading-5">
                                                Amplio catálogo de accesorios y refacciones para todas tus necesidades.
                                            </p>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="">
                                <a class="group block h-auto xl:h-128 p-8 border border-green-500 border-opacity-30 hover:border-opacity-100 rounded-3xl transition duration-200" href="#">
                                    <div class="flex h-full flex-col items-start">
                                        <i class="fas fa-check-circle text-green-500 text-3xl mb-6"></i> <!-- Icono de disponibilidad -->
                                        <div class="mt-auto max-w-xs">
                                            <h4 class="text-xl sm:text-2xl mb-2 text-black">
                                                Disponibilidad Garantizada
                                            </h4>
                                            <p class="text-gray-500 tracking-tight leading-5">
                                                Stock constante para asegurar disponibilidad inmediata de los componentes.
                                            </p>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="">
                                <a class="group block h-auto xl:h-128 p-8 border border-green-500 border-opacity-30 hover:border-opacity-100 rounded-3xl transition duration-200" href="#">
                                    <div class="flex h-full flex-col items-start">
                                        <i class="fas fa-user-tie text-green-500 text-3xl mb-6"></i> <!-- Icono de asesoría -->
                                        <div class="mt-auto max-w-xs">
                                            <h4 class="text-xl sm:text-2xl mb-2 text-black">
                                                Asesoría Experta
                                            </h4>
                                            <p class="text-gray-500 tracking-tight leading-5">
                                                Contamos con expertos para guiarte en la selección y uso de los productos.
                                            </p>
                                        </div>
                                    </div>
                                </a>
                ...
                <img class="h-80 md:h-96 object-cover object-center" src="{{ asset('img/beneficios/accesorios.jpg') }}" alt="Accesorios, Refacciones y Consumibles">
            </div>
        </div>
    </section>
    ...
    <section class="bg-gray-100">
        <div class="py-8 lg:py-16 mx-auto px-4">
            ...
            <h4 class="text-xl md:text-3xl font-light text-gray-800 text-center mb-10">
                En alianza con los principales fabricantes de accesorios y consumibles.
            </h4>
