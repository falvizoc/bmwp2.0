<section class="relative py-10 md:py-16 overflow-hidden bg-white">
    <div class="relative container px-4 mx-auto">
      ...
      <div class="max-w-4xl mx-auto flex flex-wrap items-center mb-6 md:mb-12">
        <div class="w-full lg:w-1/2 px-4 relative flex justify-center lg:justify-start mb-6 md:mb-0">
            <span class="animate-ping-slow absolute inline-flex h-32 w-32 md:h-56 md:w-56 top-12 left-40 md:top-20 md:left-24 rounded-full bg-gray-300 border border-gray-600 opacity-75"></span>
            <img class="h-56 md:h-96 p-4 object-cover object-center rounded-full relative z-10" src="{{ asset('img/eligiendoBitmovil/dimensionamiento.png')}}" alt="">
        </div>
        <div class="w-full lg:w-1/2 px-4">
            <div class="max-w-lg mx-auto lg:mr-0 text-center md:text-left">
      ...
      {{-- Puesta a punto --}}
      <div class="max-w-4xl mx-auto flex flex-wrap items-center md:items-end mb-6 md:mb-12">
        <div class="w-full lg:w-1/2 px-4">
            <div class="max-w-lg mx-auto lg:mr-0 text-center md:text-right">
        ...
        <div class="w-full lg:w-1/2 px-4 relative flex justify-center lg:justify-end mb-6 md:mb-0 order-first md:order-last">
            <span class="animate-ping-slow absolute inline-flex h-32 w-32 md:h-56 md:w-56 top-12 left-40 md:top-20 md:left-32 rounded-full bg-gray-300 border border-gray-600 opacity-75"></span>
            <img class="h-56 w-56 md:h-96 md:w-96 object-cover rounded-full relative z-10" src="{{ asset('img/eligiendoBitmovil/puestaPunto.png')}}" alt="">
        </div>
      </div>
      ...
      <div class="max-w-4xl mx-auto flex flex-wrap items-center mb-6 md:mb-12">
        <div class="w-full lg:w-1/2 px-4 relative flex justify-center lg:justify-start mb-6 md:mb-0">
            <span class="animate-ping-slow absolute inline-flex h-32 w-32 md:h-56 md:w-56 top-12 left-40 md:top-20 md:left-24 rounded-full bg-gray-300 border border-gray-600 opacity-75"></span>
            <img class="h-56 w-56 md:h-96 md:w-96 object-cover rounded-full relative z-10" src="{{ asset('img/eligiendoBitmovil/handshake.png')}}" alt="">
        </div>
        <div class="w-full lg:w-1/2 px-4">
            <div class="max-w-lg mx-auto lg:mr-0 text-center md:text-left">
                <span class="inline-block py-1 px-3 mb-4 text-xs font-semibold uppercase text-green-600 bg-green-100 rounded-full">
