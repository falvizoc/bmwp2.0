<x-admin-layout>
    ...
    <section>
        <div class="container mt-8 flex items-center justify-center">
            <div class="flex-1">
                <h2 class="text-xl text-gray-800"><i class="fas fa-EYE"></i> Visualización de <b>Servicio</b></h2>
                <p class="text-gray-700">Formulario de visualización de <b>Servicio</b></p>
            </div>
    ...
    <div class="container py-8">
        <div class="bg-white rounded shadow-lg px-8 py-6 mb-6 border-t-2 border-blue-400">
            ...
            {!! Form::model($service, ['route' => ['admin.services.update', $service], 'method' => 'put', 'files' => true]) !!}
                ...
                @include('admin.services.partials.form', ['disabled' => true])
