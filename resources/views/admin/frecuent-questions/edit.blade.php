<x-admin-layout>
    ...
    <section>
        <div class="container mt-8 flex items-center justify-center">
            <div class="flex-1">
                <h2 class="font-semibold text-xl text-gray-800"><i class="fas fa-edit"></i> Edición de <b>Pregunta Frecuente</b></h2>
                <p class="text-gray-700">Formulario de Edición de <b>Pregunta Frecuente</b></p>
            </div>
    ...
    <div class="container py-8">
        <div class="bg-white rounded shadow-lg px-8 py-6 mb-6 border-t-2 border-orange-400">
            ...
            {!! Form::model($frecuent_question, ['route' => ['admin.frecuent.questions.update', $frecuent_question], 'method' => 'put']) !!}
                            ...
                            @foreach ($paginas as $pagina)
                                <div class="mb-1">
                                    <label class="cursor-pointer">
                                        {!! Form::checkbox('paginas[]', $pagina->id, in_array($pagina->id, $selectedPages), ['class' => 'checkbox checkbox-primary m-1 rounded-full']) !!}
                                        {{$pagina->name}}
                                    </label>
                                </div>
                            @endforeach
